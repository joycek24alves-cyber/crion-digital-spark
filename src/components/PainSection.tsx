  ...
  <section className="bg-main py-32 relative overflow-hidden noise-overlay">
    ...
    <div className="relative z-10 container mx-auto px-4">
      ...
      <div className="max-w-2xl mx-auto space-y-4 mb-16">
        {pains.map((pain, i) => (
          <AnimatedSection key={i} delay={i * 0.12} variant={i % 2 === 0 ? "fadeLeft" : "fadeRight"}>
            <div className="flex items-center gap-5 rounded-2xl border border-red-500/8 bg-red-500/[0.02] p-6 card-hover-glow backdrop-blur-sm" style={{ '--tw-border-opacity': undefined } as any}>
