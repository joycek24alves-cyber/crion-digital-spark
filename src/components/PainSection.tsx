...
const PainSection = () => (
  <section className="bg-main py-28 relative overflow-hidden">
    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full bg-red-500/[0.03] blur-[140px] pointer-events-none" />
        ...
        {pains.map((pain, i) => (
          <AnimatedSection key={i} delay={i * 0.12}>
            <div className="flex items-center gap-5 rounded-xl border border-red-500/10 bg-red-500/[0.03] p-5 transition-all duration-300 hover:border-red-500/25 hover:bg-red-500/[0.06]">
              <div className="h-12 w-12 rounded-xl bg-red-500/10 flex items-center justify-center flex-shrink-0 border border-red-500/15">
